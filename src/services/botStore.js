...
function defaultSettingsTemplate(employeeName) {
  return {
    identity: {
      ...
      businessName: "",
      // اسم مختصر أو شعار تجاري بيظهر على موادكم التسويقية (زي "SJS") لو مختلف عن الاسم الكامل فوق — عشان البوت
      // ما يشك إنو صورة عرض/برومو رسمية فيها هالاسم المختصر هي لمطعم تاني (شوف promptBuilder.js).
      brandAliases: "",
      businessAddress: "",
